...
const MyOrder = () => {
    ...
    return (
        <div >
            ...
            {
                products?.length === 0 && <img className=' w-full h-full' src="https://image.freepik.com/free-vector/travel-tourism-illustration-with-resort-sightseeing-elements_1284-30189.jpg" alt="" />
            }
